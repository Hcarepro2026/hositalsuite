...
def build_inspection_pdf(org, inspection, scores_by_no: dict, dest_path: str,
    ...
    footer_left = [
        ...
        Paragraph(f"Scan the QR code or visit the verification page to confirm this report "
                  f"was generated by the hospital system and has not been altered.", st["small"]),
