...
dict(cat="clinics", intent="headache", kw=[
 ...
 cta="If it's the worst headache of your life, come to A&E now — otherwise I'll book the clinic."),
dict(cat="clinics", intent="sleep", kw=[
 ...
 cta="Tell me how long it's been and I'll route you to the right clinician."),
dict(cat="wellness", intent="stop_smoking", kw=[
 ...
 cta="I'll set you up with a supporter who's helped many quit for good."),
dict(cat="wellness", intent="obesity", kw=[
 ...
 cta="I'll pair you with a dietitian and clinician who'll cheer you on."),
dict(cat="wellness", intent="elderly_care", kw=[
 ...
 cta="Shall I book a geriatric review or a home-care assessment?"),
dict(cat="clinics", intent="adolescent_health", kw=[
 ...
 cta="I'll match them to a clinician young people feel safe with."),
dict(cat="maternity", intent="cs_section", kw=[
 ...
 cta="I can book a pre-admission counselling so you go in calm and informed."),
dict(cat="clinics", intent="circumcision", kw=[
 ...
 cta="Tell me the age and I'll schedule it with the right team."),
dict(cat="clinics", intent="hernia_piles", kw=[
 ...
 cta="I'll get you a surgical slot — most go home the same day."),
dict(cat="clinics", intent="dialysis", kw=[
 ...
 cta="Bring your previous results if you have them — I'll book your review."),
dict(cat="support", intent="chaplaincy", kw=[
 ...
 cta="Tell me your faith preference and I'll arrange a visit kindly."),
