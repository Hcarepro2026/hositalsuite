...
dict(cat="maternity", intent="anc_book", kw=[
 ...
 cta="Tell me how many weeks along you are and I'll pick the right clinic day."),
...
dict(cat="surgery", intent="surgery_dos", kw=[
 ...
 cta="Say 'checklist' and I'll text you the do's and don'ts."),
dict(cat="surgery", intent="surgery_donts", kw=[
 ...
 cta="Tell me your surgery date and I'll give you your exact fasting start time."),
dict(cat="surgery", intent="surgery_after", kw=[
 ...
 cta="I can set a reminder for your wound review — just say the word."),
...
dict(cat="laboratory", intent="lab_prep", kw=[
 ...
 cta="Tell me your test name and I'll confirm fasting for you."),
dict(cat="laboratory", intent="lab_results", kw=[
 ...
 cta="Give me your lab number and I'll find out if it's ready."),
...
dict(cat="dental", intent="dental", kw=[
 ...
 cta="Tell me if it's a check-up or pain, and I'll pick the right slot."),
dict(cat="ophthalmology", intent="eye", kw=[
 ...
 cta="Routine check or something urgent? Tell me and I'll book accordingly."),
...
dict(cat="icu", intent="icu_visiting", kw=[
 ...
 cta="Tell me the patient's name and ward and I'll get your visiting window."),
dict(cat="paediatrics", intent="paeds", kw=[
 ...
 cta="Tell me your child's age and I'll book the right clinic."),
dict(cat="neonatal", intent="neonatal", kw=[
 ...
 cta="I'll connect you to the neonatal desk for your baby's update — just confirm the name."),
...
dict(cat="terminology", intent="term_opd", kw=[
 ...
 cta="Tell me your symptom area and I'll point you to the right clinic."),
dict(cat="terminology", intent="term_general", kw=[
 ...
 cta="Paste any confusing word here and I'll explain it simply."),
...
dict(cat="family_planning", intent="family_planning", kw=[
 ...
 cta="I'll book you a private slot — tell me a day that suits you."),
...
dict(cat="equipment", intent="equipment", kw=[
 ...
 cta="Name the test and I'll give you the prep and booking steps."),
]
