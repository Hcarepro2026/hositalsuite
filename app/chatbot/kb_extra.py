...
dict(cat="records", intent="medical_records", kw=[
 ...
 cta="Bring your ID and I'll have the records desk begin right away."),
dict(cat="support", intent="wheelchair_access", kw=[
 ...
 cta="Tell me your arrival time and I'll arrange assistance at the door."),
dict(cat="support", intent="ambulance", kw=[
 ...
 cta="For emergencies, call now — I'll coordinate the team."),
...
dict(cat="support", intent="second_opinion", kw=[
 ...
 cta="Tell me the specialty and I'll line up a senior clinician for you."),
dict(cat="support", intent="mental_wellbeing", kw=[
 ...
 cta="You're not alone — shall I set up a private session?"),
dict(cat="departments", intent="physiotherapy", kw=[
 ...
 cta="Tell me what you're recovering from and I'll match you to the right therapist."),
dict(cat="departments", intent="nutrition", kw=[
 ...
 cta="Tell me your goal and I'll book you with a dietitian."),
dict(cat="support", intent="lost_found", kw=[
 ...
 cta="Describe the item and I'll get the desk searching."),
]
