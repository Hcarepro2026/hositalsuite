...
dict(cat="genetics", intent="genotype", kw=[
 ...
 cta="I'll arrange it so you both get results together, privately."),
...
dict(cat="screening", intent="breast_screening", kw=[
 ...
 cta="I'll book you with our team — private and respectful, always."),
dict(cat="screening", intent="cervical_screening", kw=[
 ...
 cta="It takes minutes and protects you for years — shall I book it?"),
dict(cat="screening", intent="prostate_screening", kw=[
 ...
 cta="Over 45, or family history? Let's get you checked — I'll book it."),
...
dict(cat="clinics", intent="tb_clinic", kw=[
 ...
 cta="Please bring a morning sample if you can — I'll book your screening."),
dict(cat="clinics", intent="ent", kw=[
 ...
 cta="Tell me what's troubling you and I'll get you the right slot."),
dict(cat="clinics", intent="skin", kw=[
 ...
 cta="I'll get you seen — tell me how long it's been bothering you."),
dict(cat="clinics", intent="joint_pain", kw=[
 ...
 cta="Tell me where it hurts and for how long — I'll route you right."),
...
dict(cat="clinics", intent="menstrual_health", kw=[
 ...
 cta="I'll book you with our gynaecology team — private and kind."),
dict(cat="packages", intent="executive_check", kw=[
 ...
 cta="I'll arrange a calm morning slot — come fasted for the bloods."),
dict(cat="packages", intent="home_care", kw=[
 ...
 cta="Tell me what support they need and I'll set up a home visit."),
dict(cat="packages", intent="telemedicine", kw=[
 ...
 cta="Tell me a convenient time and I'll send your secure link."),
dict(cat="labs", intent="blood_group", kw=[
 ...
 cta="I'll bundle it with any visit so you don't make two trips."),
]
